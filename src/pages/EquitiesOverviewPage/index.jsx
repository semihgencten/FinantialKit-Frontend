    ...
    <TabsLayout>
      <Box sx={{ textAlign: "center" }}>
        <Grid container justifyContent="left" alignItems="center" spacing={2}>
          <Grid item xs={12}>
            <Typography variant="h5" marginTop={'1rem'} component="h3" gutterBottom sx={{ display: 'flex', alignItems: 'center' }}>
          ...
          <Grid item xs={8}>
            <Graph style={{ width: '100%', height: '300px' }} />
          </Grid>
        </Grid>
      </Box>
