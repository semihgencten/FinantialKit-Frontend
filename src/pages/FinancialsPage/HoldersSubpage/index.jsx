    ...
    <TabsLayout1>
      <FinancialsTabsLayout>
        <Box sx={{ textAlign: "center", pt: 4 }}>
          ...
          <Box sx={{ mb: 4 }}>
            <Typography variant="h5" sx={{ mb: 2 }}>Insider Purchases Last 6 Months</Typography>
            <Divider sx={{ mb: 2 }} />
              ...
              <Table>
                ...
                <TableBody>
                  {insiderPurchasesData.map((row, index) => (
                    <TableRow key={index}>
                      <TableCell component="th" scope="row" sx={{ color: '#555555' }}>{row.parameter}</TableCell>
                      <TableCell sx={{ color: '#555555' }}>{row.value}</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
          ...
          <Box sx={{ mb: 4 }}>
            <Typography variant="h5" sx={{ mb: 2 }}>Top Mutual Fund Holders</Typography>
            <Divider sx={{ mb: 2 }} />
            <TableContainer component={Paper} sx={{ borderRadius: '10px' }}>
              <Table>
                <TableHead sx={{ backgroundColor: '#f3f3f3' }}>
                  <TableRow>
                    <TableCell sx={{ fontWeight: 'bold', color: '#333333' }}>Holder</TableCell>
                    <TableCell sx={{ fontWeight: 'bold', color: '#333333' }}>Shares Held</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  {topMutualFundHoldersData.map((row, index) => (
                    <TableRow key={index}>
                      <TableCell component="th" scope="row" sx={{ color: '#555555' }}>{row.holder}</TableCell>
                      <TableCell sx={{ color: '#555555' }}>{row.sharesHeld}</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
          ...
          <Box>
            <Typography variant="h5" sx={{ mb: 2 }}>Top Institutional Holders</Typography>
            <Divider sx={{ mb: 2 }} />
            <TableContainer component={Paper} sx={{ borderRadius: '10px' }}>
              <Table>
                <TableHead sx={{ backgroundColor: '#f3f3f3' }}>
